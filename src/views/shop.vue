 ...
 * @Date: 2022-12-04 17:35:49
 * @LastEditors: error: git config user.name && git config user.email & please set dead value or install git
 * @LastEditTime: 2022-12-10 15:45:29
 * @FilePath: \粤嵌上课记录\阅读app\bookapp\src\views\shop\shop.vue
...
<template>
  <div>
    <!-- 搜索框 -->
    <van-search v-model="value" placeholder="斗罗大陆" @search="onSearch" />
    <ul style="width: 100%; height: 50px; color: #cecece; line-height: 45px">
      <!-- 点击的时候传路由 -->
      <li style="margin-left: 20px; float: left"><router-link to="{name:shopchose}" style="color:black">精选</router-link></li>
      <li style="margin-left: 20px; float: left"><router-link to="/shop/shopboy" style="color:black">男生</router-link></li>
      <li style="margin-left: 20px; float: left"><router-link to="/shop/shopgirl" style="color:black">女生</router-link></li>
      <li style="margin-left: 20px; float: left"><router-link to="/shop/shopplay" style="color:black">点播</router-link></li>
      <li style="margin-left: 20px; float: left"><router-link to="/shop/shopmonth" style="color:black">包月</router-link></li>
      <li style="margin-left: 20px; float: left"><router-link to="/shop/shoppublish" style="color:black">出版</router-link></li>
    </ul>
    <!-- 循环加载搜索内容-->
...
export default {
  ...
  methods: {
    ...
    showPopup(e) {
      this.show = true;
      this.img = '<img  style="height: 150px; width: 100px; margin-right: 10px;float:left;margin-right:10px" src="http://statics.zhuishushenqi.com'+e.cover+'" alt="">'
